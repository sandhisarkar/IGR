...
namespace BurnMedia
{
    ...
    public partial class MainForm : Form
    {
        ...
        DataTable dtIn2wb = new DataTable();
        ...
        {
                bool retVal = false;
                string sqlstr = "select media_no from tbllot_media_mapping where lot_no = '" + cmbVol.Text + "'";
                DataSet ds = new DataSet();
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    textBoxLabel.Text = ds.Tables[0].Rows[0][0].ToString();
                }
                else
                {
                ...
                System.Data.DataTable dtoutsidewb = new DataTable();
                try
                {
                    int rowNum = 9;
                    ...
                    if (book == "1")
                    {
                                    ...
                                    foreach (string r in Directory.GetDirectories(districtFolder))
                                    {
                                        ...
                                        if (Directory.Exists(roFolder + "\\csv"))
                                        {
                                            if (File.Exists(roFolder + "\\csv" + "\\summary.csv"))
                                            {
                                                ...
                                                xlWorkSheet.Cells[4, 1] = "Year - " + listBoxFiles.Items[i].ToString().Substring(5, 4) + "     Book - " + listBoxFiles.Items[0].ToString().Substring(4, 1); ;
                                                ...
                                                /* xlWorkSheet.Cells[rowNum, 8] = Convert.ToInt32(csvData.Rows[0][3].ToString()) / Convert.ToInt32(csvData.Rows[0][0].ToString());
                                                 ...
                                                 int Count = ((Convert.ToInt32(csvData.Rows[0][1].ToString()) + Convert.ToInt32(csvData.Rows[0][2].ToString())) - Convert.ToInt32(csvData.Rows[0][0].ToString()) * 3);
                                                 if (Count < 0)
                                                 {
                                                     xlWorkSheet.Cells[rowNum, 9] = "0";
                                                 }
                                                 else
                                                 {
                                                     ...
                                                     xlWorkSheet.Cells[rowNum, 9] = Count.ToString();
                                                 }*/
                                                xlWorkSheet.Cells[rowNum, 8] = getUATDate();
                                            }
                                        }
                                        ...
                                        if (File.Exists(roFolder + "\\csv" + "\\deed_details.csv"))
                                        {
                                            ...
                                            if (errorcode == 1)
                                            {
                                                ...
                                                MessageBox.Show("Error in " + csv_file_path + " Please check in proper deed_details csv !");
                                                //errorcode = 0;
                                                break;
                                                ///this.Close();
                                            }
                                        ...
                                        if (File.Exists(roFolder + "\\csv" + "\\index_of_name.csv"))
                                        {
                                            ...
                                            if (errorcode == 1)
                                            {
                                                ...
                                                MessageBox.Show("Error in " + csv_file_path + " Please check in proper index_of_name csv !");
                                                //errorcode = 0;
                                                break;
                                                //this.Close();
                                            }
                                        ...
                                        if (File.Exists(roFolder + "\\csv" + "\\index_of_property.csv"))
                                        {
                                            ...
                                            if (errorcode == 1)
                                            {
                                                ...
                                                MessageBox.Show("Error in " + csv_file_path + " Please check in proper index_of_property csv !");
                                                //errorcode = 0;
                                                break;
                                                //this.Close();
                                            }   
                                        ...
                                        if (File.Exists(roFolder + "\\csv" + "\\other_plots.csv"))
                                        {
                                            ...
                                            if (errorcode == 1)
                                            {
                                                ...
                                                MessageBox.Show("Error in " + csv_file_path + " Please check in proper other_plots csv !");
                                                //errorcode = 0;
                                                break;
                                                //this.Close();
                                            }
                                        ...
                                        if (File.Exists(roFolder + "\\csv" + "\\other_khatian.csv"))
                                        {
                                            ...
                                            if (errorcode == 1)
                                            {
                                                ...
                                                MessageBox.Show("Error in " + csv_file_path + " Please check in proper other_khatian csv !");
                                                //errorcode = 0;
                                                break;
                                                //this.Close();
                                            }
                                        }
                                        if (File.Exists(roFolder + "\\csv" + "\\index_of_property_out_wb.csv"))
                                        {
                                            csv_file_path = roFolder + "\\csv" + "\\index_of_property_out_wb.csv";
                                            dtoutsidewb = GetDataTabletFromCSVFile(csv_file_path);
                                            if (errorcode == 1)
                                            {
                                               
                                                MessageBox.Show("Error in " + csv_file_path + " Please check in proper index_of_property_out_wb csv!");
                                                //errorcode = 0;
                                                break;
                                                //this.Close();
                                            }
                        ...
                        dgvoutsidewb.DataSource = dtIn2wb;
                        ...
                        tabTextFile(dgvoutsidewb, appPath + "\\NIC\\" + textBoxLabel.Text + "\\csv\\" + textBoxLabel.Text + "_index_of_property_out_wb.csv");
                        if (errorcode == 1)
                        { retVal = false; }
                        else
                        {
                            ...
                            UpdateCapacity();
                            insertMediaLog(cmbVol.Text, textBoxLabel.Text);
                            retVal = true;
                        }
                    ...
                    if(book == "3" || book == "4")
                    {
                        ...
                        //textBoxLabel.Text = "L" + cmbVol.Text.Substring(0, 4) + now.Month.ToString().PadLeft(2, '0') + now.Year.ToString().Substring(2, 2) + cmbVol.Text.Substring(4, 6);
                        string UATTemplatePath = System.IO.Path.GetDirectoryName(Application.ExecutablePath) + "\\UAT_3_4.xls";
                        string UATDestPath = System.IO.Path.GetDirectoryName(Application.ExecutablePath) + "\\NIC\\" + textBoxLabel.Text + "\\" + textBoxLabel.Text + ".xls";
                        File.Copy(UATTemplatePath, UATDestPath, true);
                        Excel.Workbook xlWorkBook = xlApp.Workbooks.Open(UATDestPath, 0, false, 5, "", "", true, Microsoft.Office.Interop.Excel.XlPlatform.xlWindows, "\t", false, false, 0, true, 1, 0);
                        Excel.Worksheet xlWorkSheet = (Excel.Worksheet)xlWorkBook.Worksheets[1];
                                    ...
                                    foreach (string r in Directory.GetDirectories(districtFolder))
                                    {
                                        ...
                                        if (Directory.Exists(roFolder + "\\csv"))
                                        {
                                            if (File.Exists(roFolder + "\\csv" + "\\summary.csv"))
                                            {
                                                ...
                                                xlWorkSheet.Cells[rowNum, 4] = csvData.Rows[0][0].ToString();
                                                xlWorkSheet.Cells[rowNum, 5] = csvData.Rows[0][1].ToString();
                                                //xlWorkSheet.Cells[rowNum, 5] = csvData.Rows[0][2].ToString();
                                                xlWorkSheet.Cells[rowNum, 6] = csvData.Rows[0][3].ToString();
                                                /* xlWorkSheet.Cells[rowNum, 8] = Convert.ToInt32(csvData.Rows[0][3].ToString()) / Convert.ToInt32(csvData.Rows[0][0].ToString());
                                                ...
                                                xlWorkSheet.Cells[rowNum, 7] = getUATDate();
                                            }
                                        }
                                        ...
                                        if (File.Exists(roFolder + "\\csv" + "\\deed_details.csv"))
                                        {
                                            ...
                                            if (errorcode == 1)
                                            {
                                                ...
                                                MessageBox.Show("Error in " + csv_file_path + " Please check in proper deed_deatils csv !");
                                                //errorcode = 0;
                                                break;
                        ...
                        xlWorkSheet.Cells[rowNum + 1, 5] = index1Count.ToString();
                        //xlWorkSheet.Cells[rowNum + 1, 6] = index2Count.ToString();
                        xlWorkSheet.Cells[rowNum + 1, 6] = totalscanPagesCount.ToString();
                        /* xlWorkSheet.Cells[rowNum+1, 8] = Convert.ToInt32(totalscanPagesCount / deedCount).ToString();
                         if (addRecord < 0)
                         {
                             xlWorkSheet.Cells[rowNum+1, 9] = "0";
        ...
        private Boolean insertMediaLog(string lot_no,string media_no)
        {
            bool flag = false;
            try
            {
                string qry = "insert into tbllot_media_mapping(lot_no,media_no) values ('" + lot_no + "','" + media_no + "')";
                OdbcCommand SqlCom = new OdbcCommand(qry,con);
