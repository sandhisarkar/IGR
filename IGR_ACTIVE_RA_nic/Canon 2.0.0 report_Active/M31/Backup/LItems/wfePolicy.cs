	...
	public class wfePolicy: wItem, StateData
	{
        ...
        public bool SaveBlankDeeds(PolicyDetails pFile,OdbcTransaction txn)
        {
            try
            {
                ...
                string sqlStr = @"INSERT INTO policy_master (proj_key, batch_key, box_number, policy_number, policy_path, created_by, created_dttm,status,scan_upload_flag,count_of_pages,photo,do_code,br_code,deed_year,deed_no,year,deed_vol,page_from,page_to)" +
                        "VALUES (" + pFile.proj_key + "," + pFile.batch_key + ",'" + pFile.box_number + "','" + pFile.policy_number + "'," +
                        "'" + pFile.policy_path + "','" + pFile.created_by + "', '" + pFile.created_dttm + "',20,'01','15','0','" + pFile.Do_code + "','" + pFile.Bo_Code + "','" + pFile.deed_year + "','" + pFile.Deed_no + "','"+ pFile.Book +"','"+ pFile.vol +"','"+ pFile.Page_from +"','"+ pFile.Page_to +"')";
                sqlTrans = txn;
