        ...
        private bool InsertintoMysqlDb()
        {
            ...
            try
            {
                ...
                //{
                    ...
                    sqlStr = "update deed_details set proj_key = '" + cmbProject.SelectedValue.ToString() + "',batch_key = '" + cmbBatch.SelectedValue.ToString() + "',box_key = '1' where District_Code = '" + cmbDistrict.SelectedValue.ToString() + "' and RO_Code = '" + cmbWhereReg.SelectedValue.ToString() + "' and Book = '" + cmbBook.SelectedValue.ToString() + "' and Deed_year = '" + txtYear.Text + "' and volume_no = '" + cmbVol.Text + "'";
