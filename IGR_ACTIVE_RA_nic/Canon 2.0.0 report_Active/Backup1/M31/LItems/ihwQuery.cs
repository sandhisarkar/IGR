...
namespace LItems
{
	...
	public class ihwQuery: wQuery
	{
        ...
        public override DataSet GetIndexDetails(string deed_no,string deed_year)
        {
            ...
            sqlStr = "select a.deed_year,a.deed_no,b.ec_name,CONCAT(a.First_name , ' '  ,a.LAST_name) as name from index_of_name a,party_code b where a.party_code = b.ec_code and a.deed_no = '" + deed_no + "' and a.deed_year = '" + deed_year + "'";
