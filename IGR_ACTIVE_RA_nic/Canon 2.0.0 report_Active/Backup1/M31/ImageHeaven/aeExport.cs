...
//		CtrlPolicy ctrlPolicy = null;
        ...
        private void PopulateBatch()
        {
            ...
            tmpProj = new wfeProject(sqlCon);
            //cmbProject.Items.Add("Select");
            ds = tmpProj.GetAllBatchRun(cmbrunNum.SelectedValue.ToString(), chkReExport.Checked);
                    ...
                    if (dgvbatch.Rows.Count > 0)
                    {
                        ...
                        for (int z = 0; z < dgvbatch.Rows.Count; z++)
                        {
                            ...
                            dgvexport.DataSource = null;
                                ...
                                if (dgvexport.Rows.Count > 0)
                                {
                                    ...
                                    for (int x = 0; x < dsexport.Tables[0].Rows.Count; x++)
                                    {
                                        ...
                                        //{
                                            ...
                                            Application.DoEvents();
                                            string aa = dsexport.Tables[0].Rows[x][4].ToString() + "\\QC";
                                            ...
                                            if (dsimage.Tables[0].Rows.Count > 0)
                                            {
                                                ...
                                                if (imageName.Length != 0)
                                                {
                                                    ...
                                                    {
                                                        MessageBox.Show("There is a prolem in one or more pages of Deed No:" + IMGName);
                                                        return;
                                                    }
                                            ...
                                            //
                                            DataTable csvdt = tmpBox.GetcsvAllPropEX1(dsexport.Tables[0].Rows[x][5].ToString(), dsexport.Tables[0].Rows[x][6].ToString(), dsexport.Tables[0].Rows[x][7].ToString(), dsexport.Tables[0].Rows[x][8].ToString(), IMGName1);
                                    ...
                                    dataGridView3.DataSource = CSVPropEx;
                                    ...
                                    string addl_Records = ((NameEx.Rows.Count + CSVPropEx.Rows.Count) - (deedEx.Rows.Count * 3)).ToString();
                                    System.Text.StringBuilder Builder = new System.Text.StringBuilder();
                                    Builder.Append(deedEx.Rows.Count.ToString());
                                    Builder.Append(",");
                                    Builder.Append(NameEx.Rows.Count.ToString());
                                    Builder.Append(",");
                                    Builder.Append(CSVPropEx.Rows.Count.ToString());
                                    Builder.Append(",");
                                ...
                                Application.DoEvents();
                                if (ExportSqlServer(deedEx, NameEx, CSVPropEx, dList, PlotEx, KhatianEx,batchPath) == true)
                                {
