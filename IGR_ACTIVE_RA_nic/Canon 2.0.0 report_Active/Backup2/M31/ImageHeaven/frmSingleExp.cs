				...
				try
				{
					...
					for (int i=0;i<lvwExportList.Items.Count;i++)
					{
						...
						if(lvwExportList.Items[i].Checked == true)
						{
			            	...
			            	ctrPol = new CtrlPolicy(Convert.ToInt32(cmbProject.SelectedValue.ToString()),Convert.ToInt32(cmbBatch.SelectedValue.ToString()),cmbBox.Text.ToString(),policyNumber);
                            ...
                            if ((status != (int)eSTATES.POLICY_MISSING) && ((status != (int)eSTATES.POLICY_ON_HOLD))&&(status != (int)eSTATES.POLICY_SCANNED)&&(status != (int)eSTATES.POLICY_QC)&&(status != (int)eSTATES.POLICY_INITIALIZED))
                            {
                                ...
                                CtrlPolicy exppPolicy = new CtrlPolicy(Convert.ToInt32(cmbProject.SelectedValue.ToString()), Convert.ToInt32(cmbBatch.SelectedValue.ToString()), lvwExportList.Items[i].SubItems[0].Text.ToString(), policyNumber);
                                ...
                                pImage = new CtrlImage(Convert.ToInt32(cmbProject.SelectedValue.ToString()), Convert.ToInt32(cmbBatch.SelectedValue.ToString()), boxno.ToString(), policyNumber, string.Empty, string.Empty);
                        ...
                        {
                            ///Update box status
                            pBox = new CtrlBox(Convert.ToInt32(cmbProject.SelectedValue.ToString()), Convert.ToInt32(cmbBatch.SelectedValue.ToString()), boxno.ToString());
