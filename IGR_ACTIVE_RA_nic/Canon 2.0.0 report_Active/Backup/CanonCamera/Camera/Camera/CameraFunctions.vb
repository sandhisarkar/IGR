...
Namespace Camerafunctions
    Public Class Camera
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Sub EstablishSession(ByVal pCamList As IntPtr, ByVal pM_cam As IntPtr)
            ...
            m_cam = pM_cam
            'get the only camera
            'CheckError(EdsGetChildAtIndex(camList, k, m_cam))
        ...
        Public Sub TakePicture(ByVal OutFile As String, ByVal pPictureBox As PictureBox, ByVal pCamera As IntPtr)
            Dim interuptingLiveView As Boolean = m_liveViewOn
            Dim lvBox As PictureBox = pPictureBox
            Dim err As Integer
            ...
            err = EdsSendStatusCommand(pCamera, EdsCameraStatusCommand.kEdsCameraStatusCommand_UILock, 0)
            ...
            err = EdsSendCommand(pCamera, EdsCameraCommand.kEdsCameraCommand_TakePicture, 0)

            If locked Then

                err = EdsSendStatusCommand(pCamera, EdsCameraStatusCommand.kEdsCameraStatusCommand_UIUnLock, 0)
